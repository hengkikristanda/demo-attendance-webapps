...
const getSections = async (req, res) => {
	try {
		...
		return res.render("memberArea/components/simpleSections/list", {
...
const getSectionsAdd = async (req, res) => {
	try {
		...
		return res.render("memberArea/components/simpleSections/add", {
		...
		req.flash("alertMessage", {
			message: "Something went wrong, please try again in a few minutes.",
			className: "danger",
			actionLink: "/member/components/simpleSections",
